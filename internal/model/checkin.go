...
type DailyCheckIn struct {
	CheckInDate      time.Time     `gorm:"type:date;not null;uniqueIndex:idx_daily_check_ins_user_date;index:idx_daily_check_ins_user_date_status" json:"check_in_date"`
	...
	BaseModel
	UserID int64 `gorm:"not null;uniqueIndex:idx_daily_check_ins_user_date;index:idx_daily_check_ins_user_date_status" json:"user_id"`
}
